...
int main(int argc, char* argv[]) {
   ...
   //       "('大将军令','打开后95%概率_i获得一个将才,5%概率获得一个猛将','baowu',4,2500);";
         sql = "INSERT INTO msg (user_id,user_name,content,type)" \
         "VALUES (1000,'系统','系统测试消息，内测中...',3);";
         // "('副将经验书','使用后提升副将1000点经验','baowu',1,300),"\
